...
interface Minute {
  id: string;
  title: string;
  date?: string;            // BWC backend camelCase
  meeting_date?: string;    // fallback snake_case
  documentUrl?: string;     // BWC backend camelCase
  document_url?: string;    // fallback snake_case
  uploadedDate?: string;
...
const FALLBACK_MINUTES: Minute[] = [
  { id: '1', title: '18th Meeting of Building & Works Committee', meeting_date: '2023-11-08', document_url: '#', uploaded_date: '2023-12-01' },
  { id: '2', title: '17th Meeting of Building & Works Committee', meeting_date: '2023-06-14', document_url: '#', uploaded_date: '2023-07-03' },
  { id: '3', title: '16th Meeting of Building & Works Committee', meeting_date: '2022-12-22', document_url: '#', uploaded_date: '2023-01-10' },
];

const API_BASE = `http://${process.env.NEXT_PUBLIC_URL || 'localhost:4000'}/bwc`;
...
export default function BwcMinutesPage() {
  ...
  const fetchMinutes = async () => {
    ...
    try {
      ...
      console.warn('Failed to load BWC minutes from backend. Using fallback data.', err);
      setMinutes(FALLBACK_MINUTES);
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                {language === 'en' ? 'Minutes of BWC' : 'भवन एवं कार्य समिति की कार्यवृत्त'}
              </h1>
              <p className="text-lg text-gray-200 max-w-3xl mx-auto">
                {language === 'en'
                  ? 'Official meeting minutes of the Building & Works Committee at NIT Hamirpur.'
                  : 'एनआईटी हमीरपुर में भवन एवं कार्य समिति की आधिकारिक बैठक कार्यवृत्त।'}
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
              ...
              <span className="text-gray-800 font-medium">
                {language === 'en' ? 'Minutes of BWC' : 'बीडब्ल्यूसी की कार्यवृत्त'}
              </span>
            </nav>
