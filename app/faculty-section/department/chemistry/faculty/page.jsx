    ...
    members: [
      {
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-pamita-awasthi145",
      },
      {
        slNo: "2",
        name: "Dr. Bharti Gaur",
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-bharti-gaur-",
      },
      {
        slNo: "3",
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-kalyan-sundar-ghosh-",
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-raj-kaushal-",
      },
      {
        slNo: "2",
        name: "Dr. Jai Prakash",
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-jai-prakash-",
      },
    ],
  },
  {
    ...
    members: [
      {
        ...
        link: "https://portfolios.nith.ac.in/index.php?/nith/dr-jagannath-kuchlyan",
      },
    ],
  },
];
  ...
  return (
    <main className="chemistry-faculty-page">
      <div className="chemistry-faculty-shell">
        <aside
          className="chemistry-faculty-sidebar"
