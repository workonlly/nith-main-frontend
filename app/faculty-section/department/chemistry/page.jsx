  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <aside style={styles.sidebar}>
        ...
        <a
          href="/faculty-section/department/chemistry/faculty"
          style={styles.sidebarLink}
        >
          Faculty
        </a>
      ...
      <main style={styles.mainContent}>
        <div style={styles.contentBox}>
          <h1 style={styles.pageTitle}>Department of Chemistry</h1>

          {/* Image */}
          <div style={styles.imagePlaceholder}>Chemistry Department Image</div>

          <p style={styles.descriptionText}>
            The Department of Chemistry came into existence as an independent
            department in August 2009. In addition to teaching UG and PG courses
            floated by various engineering departments, the department also
            offers Ph.D. degree in diverse areas of chemistry.
          </p>
          <p style={styles.descriptionText}>
            The department is currently offering M. Tech. program in Chemical
            Technology in association with Chemical Engineering department from
            the academic session 2016-17 with an intake of 15 students from both
            science and engineering backgrounds. The department has also started
            M.Sc. Program in Chemistry from the session 2017-18 with an initial
            intake of 20 students.
          </p>
          <p style={styles.descriptionText}>
            In the coming years, we plan for the extension and up gradation of
            the PG programs in terms of intake capacity as well as its
            curriculum based on current industrial requirements and needs.
            Further, the department also looks forward for active industrial
            participation in course structuring and training.
          </p>
