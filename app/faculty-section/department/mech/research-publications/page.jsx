      ...
      <main style={styles.mainContent}>
        <div style={styles.contentBox}>
          ...
          <p style={styles.descriptionText}>
            Details regarding the research publications of the Department of
            Mechanical Engineering are currently being updated. Please check
            back later or visit the individual faculty profiles for their
