...
const academicProgrammes = [
  {
    ...
    Icon: GraduationCap,
    details:
      'Bachelor Programmes Offered: B.Tech in Mechanical Engineering.',
  },
  {
    name: 'M.Tech',
    Icon: Microscope,
  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <aside style={styles.sidebar}>
        ...
        <a href="/faculty-section/department/mech/vision-mission" style={styles.sidebarLink}>
          Vision &amp; Mission
        </a>

        <a href="/faculty-section/department/mech/faculty" style={styles.sidebarLink}>
          Faculty
        </a>

        <a href="/faculty-section/department/mech/staff" style={styles.sidebarLink}>
          Staff
        </a>

        <a href="/faculty-section/department/mech/programme-offered" style={styles.sidebarLink}>
          Programme Offered
        </a>

        <a href="/faculty-section/department/mech/labs" style={styles.sidebarLink}>
          Labs
        </a>

        <a href="/faculty-section/department/mech/research-publications" style={styles.sidebarLink}>
          Research Publications
        </a>

        <a href="/faculty-section/department/mech/contact" style={styles.sidebarLink}>
          Contact
        </a>
      </aside>
