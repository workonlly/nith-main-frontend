        ...
        <div style={styles.contentBox}>
          ...
          <ul style={{ paddingLeft: "20px", margin: "0" }}>
            <li style={styles.listItem}>
              ...
              contribute effectively, efficiently and responsibly to the nation
          ...
          <ul style={{ paddingLeft: "20px", margin: "0" }}>
            <li style={styles.listItem}>
              ...
              education. To inspire our students to become responsible citizens
              and competent professionals with high ethical values. To meet the
              expectations of technical human resource at national and
              international level.
            </li>
          </ul>
        </div>
