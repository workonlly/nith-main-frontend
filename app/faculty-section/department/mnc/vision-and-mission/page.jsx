  ...
  return (
    <div style={styles.pageWrapper}>
      ...
      <aside style={styles.sidebar}>
        <a href="/faculty-section/department/mnc" style={styles.sidebarLink}>
          About Us
        </a>
      ...
      <main style={styles.mainContent}>
        <div style={styles.contentBox}>
          ...
          <p style={styles.textBlock}>
            To be a centre of excellence in Mathematics and Scientific Computing,
            fostering interdisciplinary research, innovation, and analytical thinking
          ...
          <p style={styles.textBlock}>
            To provide a strong foundation in mathematical sciences and computational
            techniques, enabling students to excel in academia, research, and industry.
          </p>
          <p style={{ ...styles.textBlock, marginBottom: '0' }}>
            To promote a culture of continuous learning, ethical practices, and
            scientific inquiry for the betterment of society.
          </p>
